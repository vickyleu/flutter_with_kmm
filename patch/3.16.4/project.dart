...
class AndroidProject extends FlutterProjectPlatform {
  ...
  Directory get _editableHostAppDirectory => isKmmModule ? parent.directory  : parent.directory.childDirectory('android');
...
''';
  ...
  bool get isUsingGradle {
    return hostAppGradleRoot.buildGradleChildFile().existsSync();
  }
  ...
  Directory get buildDirectory {
    return isKmmModule?parent.directory.childDirectory('build'):parent.buildDirectory;
  }
