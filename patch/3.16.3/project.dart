...
class AndroidProject extends FlutterProjectPlatform {
  ...
  bool get isKotlin {
    final File _appGradleFile = appGradleFile;
    final bool imperativeMatch = firstMatchInFile(_appGradleFile, _imperativeKotlinPluginPattern) != null;
    final bool declarativeMatch = firstMatchInFile(_appGradleFile, _declarativeKotlinPluginPattern) != null;
...
''';
  ...
  bool get isUsingGradle {
    return
      hostAppGradleRoot.buildGradleChildFile().existsSync();
    ;
  }
  ...
  String? get group {
    final File gradleFile = hostAppGradleRoot.buildGradleChildFile();
